...
##** Keep male data
  vL <- c("CancerSiteLevelThreeCodeAndName","ThreeYearPeriod",
          "IncidenceASRMaleThreeYrRolling","MortalityASRMaleThreeYrRolling")
...
##** remove C62 and C62 from the statistical analysis
  dat <- datx[!datx$CancerSiteLevelThreeCodeAndName%in%c("C50: Breast","C53: Cervix","C56-C57.4: Ovary","C54-C55: Uterus"),]
  dim(dat)
  dim(datx)
...
##** Get type of data ASR Incidence and Mortality
  Type <- c("IncidenceASRMaleThreeYrRolling","MortalityASRMaleThreeYrRolling")
