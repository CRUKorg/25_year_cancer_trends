...
##** Get data
  Dat35 <- read.csv("G:\\Cancer Information\\Statistical Information Team\\Data Analysis and Statistical Info\\Projects\\Working age scoping for JS\\October 2021 Update\\Raw\\ASR_BreastInc_35to49_to_2018.csv")
  Dat50 <- read.csv("G:\\Cancer Information\\Statistical Information Team\\Data Analysis and Statistical Info\\Projects\\Working age scoping for JS\\October 2021 Update\\Raw\\ASR_BreastInc_50to69_to_2018.csv")
...
write.csv(Mod,paste(Path,paste("Rcan_ASR_BreastInc","csv",sep="."),sep=""),row.names=F)
write.csv(APC.Res,paste(Path,paste("Res_ASR_BreastInc","csv",sep="."),sep=""))
